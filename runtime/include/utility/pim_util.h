...
inline uint64_t addr_gen(uint32_t chan, uint32_t rank, uint32_t bankgroup, uint32_t bank, uint32_t row, uint32_t col)
{
    const PimBlockInfo& pbi = vega20_pbi;
    int num_row_bit = pbi.num_row_bit;
    int num_col_high_bit = pbi.num_col_high_bit;
...
inline uint64_t addr_gen_safe(uint32_t chan, uint32_t rank, uint32_t bg, uint32_t bank, uint32_t& row, uint32_t& col)
{
    const PimBlockInfo& pbi = vega20_pbi;
