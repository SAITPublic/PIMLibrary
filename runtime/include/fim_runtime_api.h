...
__FIM_API__ FimDesc* FimCreateDesc(int n, int c, int h, int w, FimPrecision precision, FimOpType op_type);
...
__FIM_API__ int FimConvertDataLayout(FimBo* dst, FimBo* src, FimOpType op_type, FimDesc* fim_desc = nullptr);
...
__FIM_API__ int FimExecuteGEMV(FimBo* output, FimBo* operand0, FimBo* operand1, FimDesc* fim_desc = nullptr);
