...
class fim_cmd {
  public:
    ...
    fim_cmd()
        : type_(fim_cmd_type::NOP), dst_(fim_opd_type::A_OUT), src0_(fim_opd_type::A_OUT), src1_(fim_opd_type::A_OUT),
          src2_(fim_opd_type::A_OUT), loop_counter_(0), loop_offset_(0), is_auto_(0), dst_idx_(0), src0_idx_(0),
          src1_idx_(0) {}

    // NOP, CTRL
    fim_cmd(fim_cmd_type type, int loop_counter)
        : type_(type), dst_(fim_opd_type::A_OUT), src0_(fim_opd_type::A_OUT), src1_(fim_opd_type::A_OUT),
          src2_(fim_opd_type::A_OUT), loop_counter_(loop_counter), loop_offset_(0), is_auto_(0), dst_idx_(0),
          src0_idx_(0), src1_idx_(0)
    ...
    fim_cmd(fim_cmd_type type, int loop_counter, int loop_offset)
        : type_(type), dst_(fim_opd_type::A_OUT), src0_(fim_opd_type::A_OUT), src1_(fim_opd_type::A_OUT),
          src2_(fim_opd_type::A_OUT), loop_counter_(loop_counter), loop_offset_(loop_offset), is_auto_(0), dst_idx_(0),
          src0_idx_(0), src1_idx_(0) {}
    ...
    fim_cmd(fim_cmd_type type, fim_opd_type dst, fim_opd_type src0, int is_auto = 0, int dst_idx = 0, int src0_idx = 0,
        ...
        : type_(type), dst_(dst), src0_(src0), src1_(fim_opd_type::A_OUT), src2_(fim_opd_type::A_OUT), loop_counter_(0),
          loop_offset_(0), is_auto_(is_auto), dst_idx_(dst_idx), src0_idx_(src0_idx), src1_idx_(src1_idx), is_relu_(is_relu) {}
    ...
    fim_cmd(fim_cmd_type type, fim_opd_type dst, fim_opd_type src0, fim_opd_type src1, int is_auto = 0, int dst_idx = 0,
        ...
        : type_(type), dst_(dst), src0_(src0), src1_(src1), src2_(fim_opd_type::A_OUT), loop_counter_(0),
          loop_offset_(0), is_auto_(is_auto), dst_idx_(dst_idx), src0_idx_(src0_idx), src1_idx_(src1_idx) {}
    ...
    fim_cmd(fim_cmd_type type, fim_opd_type dst, fim_opd_type src0, fim_opd_type src1, fim_opd_type src2,
        ...
        : type_(type), dst_(dst), src0_(src0), src1_(src1), src2_(src2), loop_counter_(0), loop_offset_(0),
          is_auto_(is_auto), dst_idx_(dst_idx), src0_idx_(src0_idx), src1_idx_(src1_idx) {}
