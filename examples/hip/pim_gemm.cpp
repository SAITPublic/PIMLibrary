...
int pim_gemm_bias_relu_1x1024_1024x4096(bool block)
{
    ...
    reluCPU((half*)golden_output->data, out_size);
    ...
    ret = PimExecuteGemm(device_output, device_input, device_weight, device_bias, ACT_RELU, nullptr, block);
...
int pim_gemm_bias_relu_4x8x1024_4x1024x4096(bool block)
{
    ...
    ret = compare_half_relative((half*)golden_output->data, (half*)host_output->data, out_size / 4, epsilon);
