...
int fim_elt_mul_1(void)
{
    ...
    FimExecute(device_output, preloaded_fim_input, OP_ELT_MUL);
...
TEST(IntegrationTest, FimEltMul1) { EXPECT_TRUE(fim_elt_mul_1() == 0); }
TEST(IntegrationTest, FimEltMul2) { EXPECT_TRUE(fim_elt_mul_2() == 0); }
