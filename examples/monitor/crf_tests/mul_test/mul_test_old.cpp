...
__global__ void mul_test(uint8_t* fim_ctr, uint8_t* fim_data, uint8_t* fim_data2, uint8_t* output, uint8_t* crf_binary,
...
int main(int argc, char* argv[])
{
    ...
    ********************************************/
    ...
    hipLaunchKernelGGL(mul_test, dim3(blocks), dim3(threadsPerBlock), 0, 0, (uint8_t*)fim_base, (uint8_t*)fim_base,
