...
__global__ void relu_test(uint8_t* pim_ctr, uint8_t* pim_data, uint8_t* pim_data2, uint8_t* output, uint8_t* crf_binary,
...
int main(int argc, char* argv[])
{
    ...
    ********************************************/
    ...
    crf_bin_h[0] = 0x0000000088801000;
    ...
    hipLaunchKernelGGL(relu_test, dim3(blocks), dim3(threadsPerBlock), 0, 0, (uint8_t*)pim_base, (uint8_t*)pim_base,
