                         ...
                         volatile uint8_t* test_input1, volatile uint8_t* test_input2, int chan)
{
    ...
    //        W_CMD_R(&output[addr + offset], test_input1 + hipThreadIdx_x * 16);
    //        addr = addr_gen(ch, 0, 0, 1, 0, 1);
    //        W_CMD_R(&output[addr + offset], test_input1 + hipThreadIdx_x * 16);
    B_CMD(1);
    /* park in */
    addr = addr_gen(ch, 0, 0, 0, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 0, 1, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 0, 2, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 0, 3, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 1, 0, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 1, 1, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 1, 2, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 1, 3, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 2, 0, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 2, 1, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 2, 2, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 2, 3, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 3, 0, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 3, 1, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 3, 2, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 3, 3, (1 << 13), 0x1f);
    R_CMD(&pim_ctr[addr + offset]);
    B_CMD(1);
    ...
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 0, 2, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 0, 3, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 1, 0, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 1, 1, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 1, 2, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 1, 3, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 2, 0, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 2, 1, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 2, 2, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 2, 3, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 3, 0, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 3, 1, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 3, 2, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    addr = addr_gen(ch, 0, 3, 3, 0x2fff, 0x1f);
    W_CMD(&pim_ctr[addr + offset]);
    B_CMD(1);
...
//        ((half_float::half*)test1_h)[i] = -1.0_h;
        ...
        ((half_float::half*)test1_h)[i] = half_float::half(temp);
    }
#endif
