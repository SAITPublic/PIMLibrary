...
TEST(Pim3DCopyTestFixture, hip_PimCopyRect3D_H2D) { EXPECT_TRUE(pim_copy_rect_h2d() == 0); }
TEST(Pim3DCopyTestFixture, hip_PimCopyRect3D_D2H) { EXPECT_TRUE(pim_copy_rect_d2h() == 0); }
