...
class PyFimGemvTestConstant(unittest.TestCase):
    def test_gemv_constant(self):
        ...
        result = py_fim_ops.py_fim_gemv(inp, weight, reorder)
...
class PyFimGemvTestRandom(unittest.TestCase):
    def test_gemv_random(self):
        ...
        result = py_fim_ops.py_fim_gemv(torch.from_numpy(inp),
