...
torch::Tensor py_fim_lstm(torch::Tensor input, torch::Tensor weight, torch::Tensor hidden , torch::Tensor cell , torch::Tensor is_bi_dir , torch::Tensor n_ws_len)
{
        Timer t;
        ...
        //Todo , verify if FimCopyMemory is required
...
static auto registry = torch::RegisterOperators("custom_ops::py_fim_lstm", &py_fim_lstm);
